// <copyright file="rtx_sample.h" company="Visualisierungsinstitut der Universität Stuttgart">
// Copyright © 2023 - 2025 Visualisierungsinstitut der Universität Stuttgart.
// Licensed under the MIT licence. See LICENCE file for details.
// </copyright>
// <author>Christoph Müller</author>

#if !defined(_PWROWG_RTX_SAMPLE_H)
#define _PWROWG_RTX_SAMPLE_H
#pragma once
...
/// <see cref="rtx_waveform::segment_offset" /> to find out from
/// which channel each of the waveforms originated and which segment it is.
/// </para>
/// </remarks>
class POWER_OVERWHELMING_API rtx_sample final {
...
public:
    ...
    public:
        ...
        inline channel_waveform(_In_ const channel_type channel,
                _Inout_ rtx_waveform&& waveform) noexcept
        ...
        inline const rtx_waveform& waveform(void) const noexcept {
        ...
        /// </summary>
        /// <returns>The waveform obtained from the oscilloscope.</returns>
        inline operator const rtx_waveform&(void) const noexcept {
            return this->_waveform;
        }
    ...
    private:
        ...
        rtx_waveform _waveform;
    };

    /// <summary>
    /// Initialises a new instance.
    /// </summary>
    inline rtx_sample(void) : _size(0), _waveforms(nullptr) { }
    ...
    /// <exception cref="std::bad_alloc">If the allocation of the buffer for
    /// the waveforms failed.</exception>
    rtx_sample(_Inout_updates_(cnt) channel_waveform *waveforms,
        _In_ const std::size_t cnt);
    ...
    inline rtx_sample(_Inout_ rtx_sample&& rhs) noexcept
    ...
    rtx_sample& operator =(
        _Inout_ rtx_sample&& rhs) noexcept;
    ...
    /// and <see cref="rtx_waveform::segment_offset" /> to
...
#endif /* !defined(_PWROWG_RTX_SAMPLE_H) */
