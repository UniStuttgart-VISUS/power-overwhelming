...
#if !defined(_PWROWG_TIMESTAMP_H)
#define _PWROWG_TIMESTAMP_H
#pragma once
...
/// </summary>
/// <remarks>
/// <para>This class ensures that timestamps within the library carry  semantics
/// (fixing one of the biggest mistakes of previous versions which had time
/// being represented as a number) while preventing STL templates being used in
/// the ABI of the library at the same time. All chrono instantiations are
/// either in the library or in the client code while information passes only
/// as a number between both sides.</para>
/// <para>The timestamp provides a variety of conversion facilities, which allow
/// users to create their own from different other formats and to transform the
/// timestamp into all kinds of STL time points.</para>
/// </remarks>
...
#endif /* !defined(_PWROWG_TIMESTAMP_H) */