...
#if !defined(_PWROWG_RTX_ACQUISITION_H)
#define _PWROWG_RTX_ACQUISITION_H
#pragma once
...
/// </para>
/// </remarks>
class POWER_OVERWHELMING_API rtx_acquisition final {
...
public:
    ...
    /// </summary>
    /// <returns><c>*this</c>.</returns>
    inline rtx_acquisition& enable_automatic_points(void) noexcept {
        this->_points = 0;
        return *this;
    }
    ...
    /// <returns><c>*this</c>.</returns>
    inline rtx_acquisition& segmented(
    ...
    /// if the <see cref="rtx_acquisition" /> was obtained from the
    /// instrument.</para>
    /// </remarks>
    /// <returns>The acquisition state.</returns>
    inline rtx_acquisition_state state(void) const noexcept {
        return this->_state;
    }
    ...
    /// <see cref="rtx_acquisition_state::unknown" />, which leaves
    ...
    /// is <see cref="rtx_acquisition_state::unknown" />, the state
    /// will remain unchanged if the object is used to configure an
    /// instrument.</param>
    /// <returns><c>*this</c>.</returns>
    inline rtx_acquisition& state(
            _In_ const rtx_acquisition_state state) noexcept {
        this->_state = state;
        return *this;
    }
...
private:
    ...
    bool _segmented;
    rtx_acquisition_state _state;
};

PWROWG_NAMESPACE_END

#endif /* !defined(_PWROWG_RTX_ACQUISITION_H) */
