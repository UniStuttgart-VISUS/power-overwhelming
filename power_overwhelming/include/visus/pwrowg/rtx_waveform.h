// <copyright file="rtx_waveform.h" company="Visualisierungsinstitut der Universität Stuttgart">
// Copyright © 2023 - 2025 Visualisierungsinstitut der Universität Stuttgart.
// Licensed under the MIT licence. See LICENCE file for details.
// </copyright>
// <author>Christoph Müller</author>

#if !defined(_PWROWG_RTX_WAVEFORM_H)
#define _PWROWG_RTX_WAVEFORM_H
#pragma once
...
/// reasons.</para>
/// </remarks>
class POWER_OVERWHELMING_API rtx_waveform final {
...
public:
    ...
    rtx_waveform(_In_z_ const char *xorg,
    ...
    rtx_waveform(_Inout_ rtx_waveform&& rhs) noexcept;
...
#endif /* !defined(_PWROWG_RTX_WAVEFORM_H) */
