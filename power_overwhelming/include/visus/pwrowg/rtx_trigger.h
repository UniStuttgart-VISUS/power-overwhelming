...
#if !defined(_PWROWG_RTX_TRIGGER_H)
#define _PWROWG_RTX_TRIGGER_H
#pragma once
...
/// </summary>
class POWER_OVERWHELMING_API rtx_trigger final {
...
public:
    ...
    /// <summary>
    /// The default level for the external trigger input, in Volts.
    /// </summary>
    static constexpr auto external_level = 2.5f;
    ...
    static rtx_trigger edge(_In_z_ const wchar_t *source);
    ...
    /// <param name="source">The name of the trigger source.</param>
    /// <returns>An edge trigger.</returns>
    static rtx_trigger edge(_In_z_ const char *source);
    ...
    inline rtx_trigger_coupling coupling(void) const noexcept {
    ...
    rtx_trigger& coupling(
            _In_ rtx_trigger_coupling coupling) noexcept {
    ...
    /// </param>
    /// <returns><c>*this</c>.</returns>
    rtx_trigger& external(_In_ const float level = external_level,
        _In_ const rtx_trigger_slope slope
        = rtx_trigger_slope::rising);
    ...
    /// <returns><c>*this</c>.</returns>
    rtx_trigger& hold_off(_In_opt_z_ const wchar_t *hold_off);
    ...
    /// disable hold off</param>
    /// <returns><c>*this</c>.</returns>
    rtx_trigger& hold_off(_In_opt_z_ const char *hold_off);
    ...
    inline rtx_trigger_hysteresis hysteresis(void) const noexcept {
    ...
    /// <returns><c>*this</c>.</returns>
    rtx_trigger& hysteresis(
            _In_ rtx_trigger_hysteresis hysteresis) noexcept {
    ...
    inline const rtx_quantity& level(void) const noexcept {
        return this->_level;
    }
    ...
    /// <param name="level">The trigger level.</param>
    /// <returns><c>*this</c>.</returns>
    inline rtx_trigger& level(_In_ const input_type input,
            _In_ const rtx_quantity& level) {
        this->_input = input;
        this->_level = level;
        return *this;
    ...
    inline rtx_trigger_mode mode(void) const noexcept {
        return this->_mode;
    }
    ...
    inline rtx_trigger_slope slope(void) const noexcept {
        return this->_slope;
    }
    ...
    /// <returns><c>*this</c>.</returns>
    inline rtx_trigger& slope(
            _In_ const rtx_trigger_slope slope) noexcept {
        this->_slope = slope;
        return *this;
    }
    ...
    /// <returns><c>*this</c>.</returns>
    rtx_trigger& source(_In_z_ const wchar_t *source);
    ...
    /// modes which you can find in the manual.</param>
    /// <returns><c>*this</c>.</returns>
    rtx_trigger& source(_In_z_ const char *source);
...
private:
    ...
    rtx_trigger_coupling _coupling;
    blob _hold_off;
    rtx_trigger_hysteresis _hysteresis;
    input_type _input;
    rtx_quantity _level;
...
#endif /* !defined(_PWROWG_RTX_TRIGGER_H) */
