...
#if !defined(_PWROWG_MSR_DEVICE_FACTORY_H)
#define _PWROWG_MSR_DEVICE_FACTORY_H
#pragma once
...
/// <summary>
/// A factory class that allows for reusing <see cref="msr_device" /> instances
...
#endif /* !defined(_PWROWG_MSR_DEVICE_FACTORY_H) */
