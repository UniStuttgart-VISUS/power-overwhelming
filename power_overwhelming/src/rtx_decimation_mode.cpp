// <copyright file="rtx_decimation_mode.cpp" company="Visualisierungsinstitut der Universität Stuttgart">
...
/*
 * PWROWG_NAMESPACE::parse_rtx_decimation_mode
 */
PWROWG_NAMESPACE::rtx_decimation_mode
PWROWG_NAMESPACE::parse_rtx_decimation_mode(_In_z_ const wchar_t *str) {
#define _GCC_IS_SHIT(v) L##v
#define _FROM_STRING_CASE(v) if (::wcscmp(str, _GCC_IS_SHIT(#v)) == 0) \
return rtx_decimation_mode::v
...
const wchar_t *PWROWG_NAMESPACE::to_string(
        _In_ const rtx_decimation_mode value) {
#define _GCC_IS_SHIT(v) L##v
#define _TO_STRING_CASE(v) case rtx_decimation_mode::v:\
