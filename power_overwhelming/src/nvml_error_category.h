// <copyright file="nvml_error_category.h" company="Visualisierungsinstitut der Universität Stuttgart">
// Copyright © 2025 Visualisierungsinstitut der Universität Stuttgart.
// Licensed under the MIT licence. See LICENCE file for details.
// </copyright>
// <author>Christoph Müller</author>

#if !defined(_PWROWG_NVML_ERROR_CATEGORY_H)
#define _PWROWG_NVML_ERROR_CATEGORY_H
#pragma once
...
/// <summary>
/// An error category for <see cref="nvmlReturn_t" />.
/// </summary>
class PWROWG_TEST_API nvml_error_category final : public std::error_category {
...
/// <summary>
/// Answer the one and only <see cref="nvml_error_category" />.
/// </summary>
/// <returns>The only instance of <see cref="nvml_error_category" />.
/// </returns>
PWROWG_TEST_API const std::error_category& nvml_category(void) noexcept;
...
/// failure.</exception>
PWROWG_TEST_API void throw_if_nvml_failed(_In_ const nvmlReturn_t status,
...
namespace std {
    ...
    /// <summary>
    /// Tell STL that <see cref="nvmlReturn_t" /> is an error code enumeration.
    /// </summary>
    template<> struct is_error_code_enum<nvmlReturn_t> : true_type { };

    /// <summary>
    /// Allow STL to convert a <see cref="nvmlReturn_t" /> into a generic error
    /// code.
    /// </summary>
    /// <param name="e">The NVAPI status to be converted.</param>
    /// <returns>The generic error code.</returns>
    inline std::error_code make_error_code(const nvmlReturn_t e) noexcept {
...
#endif /* !defined(_PWROWG_NVML_ERROR_CATEGORY_H) */
