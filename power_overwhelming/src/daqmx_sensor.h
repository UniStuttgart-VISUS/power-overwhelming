// <copyright file="daqmx_sensor.h" company="Visualisierungsinstitut der Universität Stuttgart">
// Copyright © 2026 Visualisierungsinstitut der Universität Stuttgart.
// Licensed under the MIT licence. See LICENCE file for details.
// </copyright>
// <author>Christoph Müller</author>

#if !defined(_PWROWG_DAQMX_SENSOR_H)
...
/// <summary>
/// A sensor based on NI-DAQmx devices.
/// </summary>
class PWROWG_TEST_API daqmx_sensor final {
...
public:
    ...
    /// </summary>
    typedef daqmx_configuration configuration_type;

    /// <summary>
    /// The type of a list of sensors of this type.
    /// </summary>
    typedef std::list<daqmx_sensor> list_type;

    /// <summary>
    /// Create descriptions for all NI-DAQmx-based sensors in the system.
    /// </summary>
    /// <remarks>
    /// <para>It is safe to call this method on systems without a connection to
    /// a NI-DAQmx device. No descriptions are returned in this case.</para>
    /// <para>The number of sensors returned is affected by the
    /// <see cref="daqmx_configuration" /> used by the sensor array. Only
    /// sensors configured there will be returned if the device used in the
    /// sensor description matches the path to any of the devices attached to
    /// the machine.</para>
    /// </remarks>
    ...
    template<class TInput> static TInput from_descriptions(
        _In_ list_type& dst,
    ...
    template<class TIterator> daqmx_sensor(
    ...
    daqmx_sensor(const daqmx_sensor&) = delete;

    /// <summary>
    /// Finalises the instance.
    /// </summary>
    inline ~daqmx_sensor(void) noexcept {
        this->sample(false);
    }
    ...
    /// </summary>
    /// <param name="enable"><see langword="true" /> for enabling the sensor,
    /// <see langword="false" /> for disabling it.</param>
    void sample(_In_ const bool enable);

    daqmx_sensor& operator =(const daqmx_sensor&) = delete;
...
#include "daqmx_sensor.inl"

#endif /* !defined(_PWROWG_DAQMX_SENSOR_H) */
