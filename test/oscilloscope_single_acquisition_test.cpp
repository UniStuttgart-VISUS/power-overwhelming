// <copyright file="oscilloscope_single_acquisition_test.cpp" company="Visualisierungsinstitut der Universität Stuttgart">
...
namespace test {
    ...
    TEST_CLASS(oscilloscope_single_acquisition_test) {

    public:

        TEST_METHOD(test_default_ctor) {
            oscilloscope_single_acquisition acq;
