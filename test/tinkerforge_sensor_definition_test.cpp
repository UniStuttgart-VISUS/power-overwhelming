// <copyright file="tinkerforge_sensor_definiton_test.cpp" company="Visualisierungsinstitut der Universität Stuttgart">
    ...
    public:
        ...
        TEST_METHOD(test_ctor) {
...

            {
                ...
                tinkerforge_sensor_definiton dd(d);
...

            {
                ...
                tinkerforge_sensor_definiton dd(std::move(d));
        ...
        TEST_METHOD(test_assignment) {
            {
                ...
                tinkerforge_sensor_definiton dd;
