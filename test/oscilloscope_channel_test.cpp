...
namespace test {
    ...
    public:
        ...
        TEST_METHOD(test_parse_bandwidth) {
            Assert::AreEqual(int(oscilloscope_channel_bandwidth::full), int(parse_oscilloscope_channel_bandwidth(L"full")), L"full", LINE_INFO());
            Assert::AreEqual(int(oscilloscope_channel_bandwidth::limit_to_20_mhz), int(parse_oscilloscope_channel_bandwidth(L"limit_to_20_mhz")), L"limit_to_20_mhz", LINE_INFO());
            Assert::ExpectException<std::invalid_argument>([](void) {
                auto dummy = parse_oscilloscope_channel_bandwidth(L"nullptr");
            }, L"nullptr", LINE_INFO());
            Assert::ExpectException<std::invalid_argument>([](void) {
                auto dummy = parse_oscilloscope_channel_bandwidth(L"horst");
            }, L"invalid value", LINE_INFO());
        }

        TEST_METHOD(test_bandwidth_to_string) {
            Assert::AreEqual(L"full", to_string(oscilloscope_channel_bandwidth::full), L"full", LINE_INFO());
            Assert::AreEqual(L"limit_to_20_mhz", to_string(oscilloscope_channel_bandwidth::limit_to_20_mhz), L"limit_to_20_mhz", LINE_INFO());
            Assert::ExpectException<std::invalid_argument>([](void) {
                auto dummy = to_string(static_cast<oscilloscope_channel_bandwidth>(-1));
            }, L"invalid value", LINE_INFO());
        }

        TEST_METHOD(test_parse_coupling) {
            Assert::AreEqual(int(oscilloscope_channel_coupling::alternating_current_limit), int(parse_oscilloscope_channel_coupling(L"alternating_current_limit")), L"alternating_current_limit", LINE_INFO());
            Assert::AreEqual(int(oscilloscope_channel_coupling::direct_current_limit), int(parse_oscilloscope_channel_coupling(L"direct_current_limit")), L"direct_current_limit", LINE_INFO());
            Assert::AreEqual(int(oscilloscope_channel_coupling::ground), int(parse_oscilloscope_channel_coupling(L"ground")), L"ground", LINE_INFO());
            Assert::ExpectException<std::invalid_argument>([](void) {
                auto dummy = parse_oscilloscope_channel_bandwidth(L"nullptr");
            }, L"nullptr", LINE_INFO());
            Assert::ExpectException<std::invalid_argument>([](void) {
        ...
        TEST_METHOD(test_coupling_to_string) {
            Assert::AreEqual(L"alternating_current_limit", to_string(oscilloscope_channel_coupling::alternating_current_limit), L"alternating_current_limit", LINE_INFO());
            Assert::AreEqual(L"direct_current_limit", to_string(oscilloscope_channel_coupling::direct_current_limit), L"direct_current_limit", LINE_INFO());
            Assert::AreEqual(L"ground", to_string(oscilloscope_channel_coupling::ground), L"ground", LINE_INFO());
            Assert::ExpectException<std::invalid_argument>([](void) {
                auto dummy = to_string(static_cast<oscilloscope_channel_bandwidth>(-1));
            }, L"invalid value", LINE_INFO());
        }
        ...
        TEST_METHOD(test_parse_polarity) {
            Assert::AreEqual(int(oscilloscope_channel_polarity::normal), int(parse_oscilloscope_channel_polarity(L"normal")), L"normal", LINE_INFO());
            Assert::AreEqual(int(oscilloscope_channel_polarity::inverted), int(parse_oscilloscope_channel_polarity(L"inverted")), L"inverted", LINE_INFO());
            Assert::ExpectException<std::invalid_argument>([](void) {
        ...
        TEST_METHOD(test_polarity_to_string) {
            Assert::AreEqual(L"normal", to_string(oscilloscope_channel_polarity::normal), L"normal", LINE_INFO());
            Assert::AreEqual(L"inverted", to_string(oscilloscope_channel_polarity::inverted), L"inverted", LINE_INFO());
            Assert::ExpectException<std::invalid_argument>([](void) {
                auto dummy = to_string(static_cast<oscilloscope_channel_polarity>(-1));
            }, L"invalid value", LINE_INFO());
        }
    };
