// <copyright file="trigger_test.cpp" company="Visualisierungsinstitut der Universität Stuttgart">
        ...
        TEST_METHOD(test_edge) {
            {
                ...
                t.slope(oscilloscope_trigger_slope::falling);
                Assert::AreEqual(int(oscilloscope_trigger_slope::falling), int(t.slope()), L"Set coupling", LINE_INFO());
